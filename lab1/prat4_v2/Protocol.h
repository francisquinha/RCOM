...
struct linkLayer {
	...
	int timeout; /*Valor do temporizador: 1 s*/
	 int numTransmissions; /*Número de tentativas em caso de
								   falha*/
	 int Iframe_numdatabytes_withoutstuffing;
...
void set_basic_definitions(int timeout_in_seconds, int number_of_tries_when_failing, char* port, int boudrate, int iframedatasize);
