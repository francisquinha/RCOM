...
Para tal são usadas duas sockets, uma para comandos e outra para dados, de acordo com o modelo descrito na secção 2.3 do protocolo RFC959.
Os comandos usados podem ser verificados na secção 4 (páginas 25 a 34)  e na página 47 do protocolo RFC959. É usado o comando PASV sendo que o servidor não usa a porta default para os dados (porta 20) e fica à espera que o cliente estabeleça a ligação.
